...
I'll extract the color system from the image and organize it for you.
...
- Secondary: `#5D5D5D`
- Tertiary: `#8F8F8F`
- Inverted: `#8F8F8F` *(note: label says #8F8F8F but visually appears white on black — likely a doc typo; inverted text on dark bg is typically white)*

**Icon**
- Primary: `#0D0D0D`
- Secondary: `#5D5D5D`
- Tertiary: `#8F8F8F`
- Inverted: `#8F8F8F` *(same note as above)*
