...
Detailed installation guide for Uniro with troubleshooting tips.
...
Install Uniro globally to use from anywhere:
...
- ✅ Simple command: `uniro`
- ✅ Auto-updates with `npm update -g uniro`
...
3. Data directory created at `~/.uniro`
...
**Issue:** Uniro using too much RAM
