...
Integrate Uniro with OpenAI Codex CLI to route your OpenAI API requests through Uniro's intelligent routing system.
...
Uniro provides the following Codex models:
...
1. Verify your API key is correct in Uniro dashboard
...
1. Verify the model name matches your Uniro configuration
2. Check that the OpenAI provider connection is active in Uniro dashboard
...
Make sure you have configured your API key in the Uniro cloud dashboard.
