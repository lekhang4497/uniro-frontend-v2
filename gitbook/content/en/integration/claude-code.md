...
Integrate Uniro with Claude Code CLI to route your Anthropic API requests through Uniro's intelligent routing system.
...
Claude Code supports the following model aliases that map to Uniro models:
