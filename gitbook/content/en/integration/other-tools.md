...
Uniro is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

Uniro provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to Uniro using these settings:

**Local Uniro:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any Uniro model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to Uniro
```bash
...
- Check network connection to Uniro
