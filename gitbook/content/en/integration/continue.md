...
Integrate Uniro with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- Uniro API key from [dashboard](https://www.uniro.tech/dashboard)
- Uniro running (local or cloud)
...
### 2. Add Uniro Model Configuration
...
3. Choose your preferred Uniro model
...
- Check network latency to Uniro
