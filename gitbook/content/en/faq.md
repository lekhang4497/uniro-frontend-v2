...
Common questions about Uniro.

---

## What is Uniro?

**Uniro is an AI model router that maximizes your subscription value and minimizes costs.**
...
**Uniro uses a 3-tier pricing strategy:**
...
**Yes, Uniro itself is 100% free and open source.**
...
**Yes! This is Uniro's core feature.**
...
**Uniro tracks quota in real-time for all providers:**
...
## Can I self-host Uniro?

**Yes! Uniro supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.uniro`)
...
**Yes, Uniro prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.uniro` (or custom `DATA_DIR`)
- No data sent to Uniro servers
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/your-org/uniro/blob/main/CHANGELOG.md)
- Backup `~/.uniro` before major updates
...
See [CONTRIBUTING.md](https://github.com/your-org/uniro/blob/main/CONTRIBUTING.md) for details.
