...
UniroをClaude Code CLIと統合し、AnthropicのAPIリクエストをUniroのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはUniroモデルにマッピングされる以下のモデルエイリアスをサポート:
