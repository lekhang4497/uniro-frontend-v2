...
Guía detallada de instalación de Uniro con consejos de solución de problemas.
...
Instala Uniro globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `uniro`
- ✅ Auto-actualizaciones con `npm update -g uniro`
...
3. Se crea el directorio de datos en `~/.uniro`
...
**Error:**
```
Error: EACCES: permission denied, mkdir '/usr/local/lib/node_modules/uniro'
```
...
**Problema:** Uniro usa demasiada RAM
...
```bash
docker pull uniro/uniro:latest

docker run -d \
  -p 20128:20128 \
  -e JWT_SECRET="your-secure-secret" \
  -e INITIAL_PASSWORD="your-password" \
  -v uniro-data:/root/.uniro \
  --name uniro \
  uniro/uniro:latest
```
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con uniro
```
...
- **Sitio web**: [www.uniro.tech](https://www.uniro.tech)
