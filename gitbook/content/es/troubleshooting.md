...
Problemas comunes y soluciones al usar Uniro.
...
1. **Refresh automático (por defecto):**
   Uniro refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
1. **Verifica si Uniro está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep uniro
