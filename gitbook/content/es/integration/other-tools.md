...
Uniro es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

Uniro proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a Uniro usando estas configuraciones:

**Uniro local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Uniro (cc/*, cx/*, glm/*, etc.)
```

**Uniro en la nube:**
```
Base URL: https://www.uniro.tech/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Uniro (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a Uniro
```bash
# Verifica si Uniro está corriendo
...
**Solución:**
- Verifica que Uniro esté corriendo
...
- Verifica la conexión de red a Uniro
