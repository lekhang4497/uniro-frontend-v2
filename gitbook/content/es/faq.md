...
Preguntas comunes sobre Uniro.

---

## ¿Qué es Uniro?

**Uniro es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**Uniro usa una estrategia de precios de 3 niveles:**
...
**Sí, Uniro en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de Uniro.**
...
**Uniro rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Uniro funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de Uniro:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://www.uniro.tech/v1
...
## ¿Puedo auto-hospedar Uniro?

**¡Sí! Uniro soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.uniro`)
...
**Sí, Uniro prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.uniro` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de Uniro
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/your-org/uniro/blob/main/CHANGELOG.md)
- Respalda `~/.uniro` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/your-org/uniro/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/your-org/uniro/discussions)
   - Describe el caso de uso y los beneficios

3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/uniro.git
   cd uniro
...
Consulta [CONTRIBUTING.md](https://github.com/your-org/uniro/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [www.uniro.tech/docs](https://www.uniro.tech/docs)
