...
Tích hợp Uniro với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model Uniro có sẵn:
...
### Connection Failed
- Xác minh Uniro đang chạy: `curl http://localhost:20128/health`
