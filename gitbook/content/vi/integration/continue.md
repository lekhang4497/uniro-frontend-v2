...
Tích hợp Uniro với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- Uniro API key từ [dashboard](https://www.uniro.tech/dashboard)
- Uniro đang chạy (cục bộ hoặc cloud)
...
- Kiểm tra Uniro đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến Uniro
