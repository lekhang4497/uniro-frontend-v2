...
Những câu hỏi phổ biến về Uniro.

---

## Uniro là gì?

**Uniro là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**Uniro dùng chiến lược pricing 3 tầng:**
...
## Uniro có miễn phí không?

**Có, Uniro hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của Uniro.**
...
**Uniro theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host Uniro không?

**Có! Uniro hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.uniro`)
...
**Có, Uniro ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.uniro` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server Uniro
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/your-org/uniro/blob/main/CHANGELOG.md)
- Backup `~/.uniro` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/your-org/uniro/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [www.uniro.tech/docs](https://www.uniro.tech/docs)
