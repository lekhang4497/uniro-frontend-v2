...
Hướng dẫn cài đặt chi tiết cho Uniro với mẹo troubleshooting.
...
Cài Uniro toàn cục để dùng ở bất kỳ đâu:
...
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `uniro`
- ✅ Auto-update với `npm update -g uniro`
...
3. Data directory được tạo tại `~/.uniro`
...
**Vấn đề:** Uniro dùng quá nhiều RAM
