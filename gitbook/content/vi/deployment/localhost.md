...
Chạy Uniro trên máy cá nhân để phát triển và dùng cá nhân.

---

## 📦 Cài đặt

Cài đặt Uniro toàn cục qua npm:
...
Khởi động Uniro với một lệnh duy nhất:
...
Nhấn `Ctrl+C` trong terminal đang chạy Uniro.
