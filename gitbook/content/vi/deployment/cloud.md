...
Triển khai Uniro trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.uniro` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/uniro`:
...
# If NOT using reverse proxy, allow Uniro ports
