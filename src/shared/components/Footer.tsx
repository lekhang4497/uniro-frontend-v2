...
const footerLinks: Record<"product" | "resources" | "company", FooterLink[]> = {
  product: [
...
export default function Footer() {
  return (
    <footer className="bg-[var(--bg-primary)] border-t border-[var(--bg-secondary)] pt-16 pb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold text-[var(--text-primary)]">{APP_CONFIG.name}</span>
            </div>
            <p className="text-[var(--text-secondary)] mb-6 max-w-sm font-light">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-[var(--text-secondary)] font-light">
              {footerLinks.product.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="hover:text-[var(--accent-blue)] transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
