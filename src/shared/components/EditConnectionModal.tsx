...
export interface Connection {
  ...
  authType?: string;
  provider?: string;
  providerSpecificData?: Record<string, unknown> & Partial<AzureData> & Partial<CloudflareData>;
}
...
export interface EditConnectionModalProps {
  ...
  // proxyPools accepted for API compat; currently not rendered in this modal
...
export default function EditConnectionModal({
  ...
  const [validationResult, setValidationResult] = useState<TestResult>(null);
  ...
  const isCompatible = connection?.provider
    ...
    <Modal isOpen={isOpen} title="Edit Connection" onClose={onClose}>
      <div className="flex flex-col gap-4">
        ...
        {isOAuth && connection.email && (
          <div className="bg-[var(--bg-secondary)]/50 p-3 rounded-[var(--radius-md)]">
        ...
        {isAzure && (
          <div className="bg-[var(--bg-secondary)]/50 p-4 rounded-[var(--radius-md)] border border-[var(--accent-blue)]/20">
