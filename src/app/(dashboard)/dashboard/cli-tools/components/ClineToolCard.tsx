...
export default function ClineToolCard({ tool, isExpanded, onToggle, baseUrl, apiKeys, activeProviders, cloudEnabled, initialStatus, tunnelEnabled, tunnelPublicUrl, tailscaleEnabled, tailscaleUrl }: any) {
              ...
              {showInstallGuide && (
                <div className="p-4 bg-[var(--bg-elevated)] border border-border rounded-lg">
                  ...
                  <div className="space-y-3 text-sm">
                    <p className="text-[var(--text-secondary)]">Install Cline VS Code extension or CLI from <a className="text-primary underline" href="https://docs.cline.bot/" target="_blank" rel="noreferrer">docs.cline.bot</a>.</p>
                  </div>
                </div>
              )}
            </div>
