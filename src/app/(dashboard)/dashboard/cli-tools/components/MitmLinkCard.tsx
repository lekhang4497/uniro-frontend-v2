 ...
 */
export default function MitmLinkCard({ tool }: { tool: Tool }) {
  return (
    <Link href="/dashboard/mitm" className="block">
      <Card padding="sm" className="overflow-hidden hover:border-[var(--accent-orange)]/50 transition-colors cursor-pointer">
