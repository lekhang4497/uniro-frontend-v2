...
export default function KiloToolCard({ tool, isExpanded, onToggle, baseUrl, apiKeys, activeProviders, cloudEnabled, initialStatus, tunnelEnabled, tunnelPublicUrl, tailscaleEnabled, tailscaleUrl }: any) {
  ...
  const getConfigStatus = () => {
    ...
    return status.hasUniro ? "configured" : "not_configured";
  };
            ...
            <div className="flex flex-col gap-4">
              ...
              {showInstallGuide && (
                <div className="p-4 bg-[var(--bg-elevated)] border border-border rounded-lg">
                  ...
                  <p className="text-sm text-[var(--text-secondary)]">Install Kilo Code from <a className="text-primary underline" href="https://kilocode.ai" target="_blank" rel="noreferrer">kilocode.ai</a> or VS Code extension marketplace.</p>
                </div>
              )}
            </div>
          )}
