        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Install Uniro, configure your providers via web dashboard, and start routing AI requests.
            </p>
            ...
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-[#2a2926] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                ...
                <div className="text-gray-400 mb-6">
                  <span className="text-[#d97757]">&gt;</span> Starting Uniro...<br/>
                ...
                <div className="text-gray-400 text-xs">
                  ...
                  <span className="text-gray-500">  macOS/Linux:</span> ~/.uniro/db/data.sqlite<br/>
                  <span className="text-gray-500">  Windows:</span> %APPDATA%/uniro/db/data.sqlite
                </div>
              </div>
            </div>
          </div>
