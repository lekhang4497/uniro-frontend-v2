<div align="center">
  <img src="./images/uniro.png?1" alt="Uniro Dashboard" width="800"/>
  
  # Uniro - FREE AI Router & Token Saver
  
  **Never stop coding. Save 20-40% tokens with RTK + auto-fallback to FREE & cheap AI models.**
  
  **Connect All AI Code Tools (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) to 40+ AI Providers & 100+ Models.**
  
  [![npm](https://img.shields.io/npm/v/uniro.svg)](https://www.npmjs.com/package/uniro)
  [![Downloads](https://img.shields.io/npm/dm/uniro.svg)](https://www.npmjs.com/package/uniro)
  [![License](https://img.shields.io/npm/l/uniro.svg)](https://github.com/your-org/uniro/blob/main/LICENSE)

  <a href="https://trendshift.io/repositories/22628" target="_blank"><img src="https://trendshift.io/api/badge/repositories/22628" alt="decolua%2Funiro | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
  
  [🚀 Quick Start](#-quick-start) • [💡 Features](#-key-features) • [📖 Setup](#-setup-guide) • [🌐 Website](https://www.uniro.tech)
...
This repository package is private (`uniro-app`), so source/Docker execution is the expected local development path.
...
<table>
  <tr>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
        <img src="https://img.youtube.com/vi/raEyZPg5xE0/maxresdefault.jpg" alt="Uniro Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>Uniro + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=X69n5Lm06Yw">
        <img src="https://img.youtube.com/vi/X69n5Lm06Yw/maxresdefault.jpg" alt="Tiết kiệm chi phí LLM với Uniro" width="300"/>
      </a><br/>
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw với Uniro<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
  ...
  <tr>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with Uniro 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + Uniro<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
...
> 🎬 **Made a video about Uniro?** Submit a [Pull Request](https://github.com/your-org/uniro/pulls) adding your video to this section — we'll merge it!

---

## 🛠️ Supported CLI Tools

Uniro works seamlessly with all major AI coding tools:
...
- Your CLI tool sends OpenAI format → Uniro translates → Provider receives native format
...
> Uniro itself **never charges** you anything. You only pay providers directly (if using paid services).
> 
...
### 📊 Understanding Uniro Costs & Billing

**Uniro Billing Reality:**

✅ **Uniro software = FREE forever** (open source, never charges)  
✅ **Dashboard "costs" = Display/tracking only** (not actual bills)  
✅ **You pay providers directly** (subscriptions or API fees)  
✅ **FREE providers stay FREE** (iFlow, Kiro, Qwen = $0 unlimited)  
❌ **Uniro never sends invoices** or charges your card
...
- **Cheap providers** (GLM, MiniMax): Pay them directly, Uniro just routes
- **FREE providers** (iFlow, Kiro, Qwen): Genuinely free forever, no hidden charges
- **Uniro**: Never charges anything, ever
...
The dashboard tracks your token usage and displays **estimated costs** as if you were using paid APIs directly. This is **not actual billing** - it's a reference to show how much you're saving by using free models or existing subscriptions through Uniro.
...
<details>
<summary><b>💳 Will I be charged by Uniro?</b></summary>

**No.** Uniro is free, open-source software that runs on your own computer. It never charges you anything.

**You only pay:**
- ✅ **Subscription providers** (Claude Code $20/mo, Codex $20-200/mo) → Pay them directly on their websites
- ✅ **Cheap providers** (GLM, MiniMax) → Pay them directly, Uniro just routes your requests
- ❌ **Uniro itself** → **Never charges anything, ever**

Uniro is a local proxy/router. It doesn't have your credit card, can't send invoices, and has no billing system. It's completely free software.
...
Uniro just routes your requests to them - there's no "catch" or future billing. They're truly free services, and Uniro makes them easy to use with fallback support.
...
3. **Use subscription providers last:**
   ...
   - Uniro helps maximize their value through quota tracking
...
Uniro's smart fallback prevents surprise charges:
...
**You're in control:** Set spending limits per provider in dashboard, and Uniro respects them.
...
**Pro Tip:** Use Opus for complex tasks, Sonnet for speed. Uniro tracks quota per model!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from uniro dashboard]
...
```json
{
  ...
  "anthropic_api_key": "your-uniro-api-key"
}
```
...
export OPENAI_API_KEY="your-uniro-api-key"
...
```json
{
  "agents": {
    "defaults": {
      "model": {
        "primary": "uniro/kr/claude-sonnet-4.5"
      }
    }
  },
  "models": {
...
> **Note:** OpenClaw only works with local Uniro. Use `127.0.0.1` instead of `localhost` to avoid IPv6 resolution issues.
...
```bash
# Clone and install
git clone https://github.com/your-org/uniro.git
cd uniro
npm install
npm run build
...
export DATA_DIR="/var/lib/uniro"
export PORT="20128"
export HOSTNAME="0.0.0.0"
export NODE_ENV="production"
export NEXT_PUBLIC_BASE_URL="http://localhost:20128"
export NEXT_PUBLIC_CLOUD_URL="https://www.uniro.tech"
...
# Or use PM2
npm install -g pm2
pm2 start npm --name uniro -- start
pm2 save
pm2 startup
```
...
docker run -d \
  --name uniro \
  -p 20128:20128 \
  --env-file /root/dev/uniro/.env \
  -v uniro-data:/app/data \
  -v uniro-usage:/root/.uniro \
  uniro
```
...
```bash
docker logs -f uniro
docker restart uniro
docker stop uniro && docker rm uniro
```
...
|----------|---------|-------------|
| `JWT_SECRET` | `uniro-default-secret-change-me` | JWT signing secret for dashboard auth cookie (**change in production**) |
| `INITIAL_PASSWORD` | `123456` | First login password when no saved hash exists |
| `DATA_DIR` | `~/.uniro` | Main app database location (`db.json`) |
| `PORT` | framework default | Service port (`20128` in examples) |
| `HOSTNAME` | framework default | Bind host (Docker defaults to `0.0.0.0`) |
| `NODE_ENV` | runtime default | Set `production` for deploy |
| `BASE_URL` | `http://localhost:20128` | Server-side internal base URL used by cloud sync jobs |
| `CLOUD_URL` | `https://www.uniro.tech` | Server-side cloud sync endpoint base URL |
| `NEXT_PUBLIC_BASE_URL` | `http://localhost:3000` | Backward-compatible/public base URL (prefer `BASE_URL` for server runtime) |
| `NEXT_PUBLIC_CLOUD_URL` | `https://www.uniro.tech` | Backward-compatible/public cloud URL (prefer `CLOUD_URL` for server runtime) |
...
- Both `${DATA_DIR}` and `~/.uniro` resolve to the same location in a Docker container — the symlink `/root/.uniro -> /app/data` is created at build time.
...
- **Website**: [www.uniro.tech](https://www.uniro.tech)
- **GitHub**: [github.com/your-org/uniro](https://github.com/your-org/uniro)
- **Issues**: [github.com/your-org/uniro/issues](https://github.com/your-org/uniro/issues)

---

## 👥 Contributors

Thanks to all contributors who helped make Uniro better!

[![Contributors](https://contrib.rocks/image?repo=your-org/uniro&max=150&columns=15&anon=1&v=20260309)](https://github.com/your-org/uniro/graphs/contributors)

---

## 📊 Star Chart

[![Star Chart](https://starchart.cc/your-org/uniro.svg?variant=adaptive)](https://starchart.cc/your-org/uniro)



## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — A full-featured TypeScript fork of Uniro. Adds 36+ providers, 4-tier auto-fallback, multi-modal APIs (images, embeddings, audio, TTS), circuit breaker, semantic cache, LLM evaluations, and a polished dashboard. 368+ unit tests. Available via npm and Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Rust token-saver. Uniro ports its compression pipeline to JS → **−20-40% input tokens** on every request.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) by **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral *"why use many token when few token do trick"*. Uniro adapts its prompt → **−65% output tokens**.

Huge thanks to these authors — without their work, Uniro's token-saving features wouldn't exist. ⭐ them on GitHub!
